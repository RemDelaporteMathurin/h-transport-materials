...
liu_diffusivity_tungsten = ArheniusProperty(
    pre_exp=5.13e-8, act_energy=0.21,
    range=(200, 3000),
    source=liu_src, name="H Liu (2014)")
...
heinola_diffusivity_tungsten = ArheniusProperty(
    pre_exp=5.2e-8, act_energy=0.21,
    source=heinola_src, name="H Heinola (2010)")
...
johnson_diffusivity_tungsten_h = ArheniusProperty(
    pre_exp=6.32e-7, act_energy=0.39,
    source=johnson_src, name="H Johnson (2010)")

johnson_diffusivity_tungsten_t = ArheniusProperty(
    pre_exp=5.16e-7, act_energy=0.40,
    source=johnson_src, name="T Johnson (2010)")


moore_src = "Close G.E. Moore, F.C. Unterwald J. Chem. Phys., 40 (1964), p. 2639"
moore_diffusivity_tungsten_t = ArheniusProperty(
    pre_exp=7.2e-8, act_energy=173.7e3*k_B/Rg,
    range=(1510, 1902),
    source=moore_src, name="T Moore (1964)")


zakharov_diffusivity_tungsten_h = ArheniusProperty(
    pre_exp=6.0e-4, act_energy=103.4*k_B/Rg,
    range=(400, 1200),
...
ryabchikov_diffusivity_tungsten_h = ArheniusProperty(
    pre_exp=8.1e-6, act_energy=82.9*k_B/Rg,
    range=(1055, 1570),
...
esteban_diffusivity_tungsten_h = ArheniusProperty(
    pre_exp=5.68e-10, act_energy=9.3e3*k_B/Rg,
    range=(673, 1073),
    source=esteban_src,
    name="H Esteban (2001)")

esteban_diffusivity_tungsten_d = ArheniusProperty(
    pre_exp=5.49e-10, act_energy=10e3*k_B/Rg,
    range=(673, 1073),
    source=esteban_src,
    name="D Esteban (2001)")

esteban_diffusivity_tungsten_t = ArheniusProperty(
    pre_exp=5.34e-10, act_energy=11.2e3*k_B/Rg,
    range=(673, 1073),
    source=esteban_src,
    name="T Esteban (2001)")
...
esteban_solubility_tungsten_h = ArheniusProperty(
    pre_exp=2.9e-2*avogadro_nb, act_energy=26.9e3*k_B/Rg,
    range=(673, 1073),
    source=esteban_src,
    name="H Esteban (2001)")

esteban_solubility_tungsten_d = ArheniusProperty(
    pre_exp=.75e-2*avogadro_nb, act_energy=28.7e3*k_B/Rg,
    range=(673, 1073),
    source=esteban_src,
    name="D Esteban (2001)")

esteban_solubility_tungsten_t = ArheniusProperty(
    pre_exp=2.25e-2*avogadro_nb, act_energy=27.8e3*k_B/Rg,
    range=(673, 1073),
    source=esteban_src,
    name="T Esteban (2001)")
